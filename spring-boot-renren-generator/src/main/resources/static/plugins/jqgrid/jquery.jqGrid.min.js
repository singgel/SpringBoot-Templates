...
q,r=a("<input type='button' value='+' title='Add filter' class='add-filter ui-add "+j.button+"'/>");r.bind("click",function(){for(void
...
E=a("<input type='button' value='-' title='Delete filter' class='delete-filter ui-del "+j.button+"'/>");D.append(E),E.bind("click",function(){for(d=0;d<c.rules.length;d++)if(c.rules[d]===b){c.rules.splice(d,1);break}return n.reDraw(),n.onchange(),!1})}return p},this.getStringForGroup=function(a){var
b,c="(";if(void
...
d=a(c.target);return!b.searchOnEnter||13!==c.which||d.hasClass("add-group")||d.hasClass("add-filter")||d.hasClass("delete-group")||d.hasClass("delete-filter")||d.hasClass("fm-button")&&d.is("[id$=_query]")?b.closeOnEscape&&27===c.which?(a("#"+a.jgrid.jqID(i.modalhead)).find(".ui-jqdialog-titlebar-close").click(),!1):void
